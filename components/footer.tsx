...
const footerLinks = { Εξερεύνηση: [["Υπηρεσίες", "#services"], ["Εμείς", "#team"], ["Τιμές", "/pricing"], ["Clients", "#clients"], ["Stack", "#tools"]], Εταιρεία: [["Σχετικά με εμάς", "/"], ["Μίλησέ μας", "#contact"], ["Instagram", "#"]] }
